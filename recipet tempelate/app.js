window.onload = function(){
    document.getElementById("download").addEventListener("click",()=>{
        ...
        // invoice.style.width = '1315px'
        // body.style.width = "100%"
        // invoice.classList.add('hide')
        ...
        let opt = {
          ...
          html2canvas:  { scale: 2 },
          jsPDF:        { unit: 'in', format: 'letter', orientation: 'portrait', quality: 1  },
        };
...
`<div class="d-flex row list-item">
...
if(number===27 || number===52 || number===77 || number===102){
  ...
  let val = itemsArr.reduce(function(previousValue, currentValue) {
    ...
    let list2 =
    `<div class="d-flex row flex-row-reverse align-content-center price-list">
